...
void UHF_RFID_2::Sendcommand(UBYTE com_nub)
{
  UBYTE b = 0;
  while (RFID_cmdnub[com_nub][b] != 0x7E)
  {
...
void UHF_RFID_2::Send_the_modified_command()
{
...
UBYTE UHF_RFID_2::Return_to_convert(UBYTE mod)
{
  DATA_Str_M5led = "";
  switch (mod)
  {
...
UDOUBLE UHF_RFID_2::String_to_command_frame(String str_epc) //EPC string to command frame EPC字符串转命令帧
{
...
void UHF_RFID_2::Warningmessage(UBYTE nub)
{
  switch (nub)
  {
    case 0x17:
...
void UHF_RFID_2::Delay(unsigned long xms)
{
  delay(xms);
}


UBYTE  UHF_RFID_2::DelayScanwarning()
{
  UDOUBLE i = 0;
  for ( i = 0; i < sizeof(DATA_I) - 6; i++)
  {
...
void UHF_RFID_2::Copy_command_library( UBYTE com_nub)
{
...
void UHF_RFID_2::Check_bit_accumulation()
{
...
UWORD UHF_RFID_2::ToHex(UDOUBLE parameters, UBYTE MSB, UBYTE LSB)
{
...
UBYTE UHF_RFID_2::Verify_the_return(UBYTE a[] , UBYTE size_v)  //Verify return information 验证返回信息
{
  UBYTE c = 0;
 ...
 *  Used to transfer string EPC to command frame
  ...
  用于将字符串EPC转命令帧
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
UBYTE UHF_RFID_2::EPC_string_to_command_frame(String str_epc, UBYTE MSB, UBYTE LSB)
{
  UBYTE b  = 0;
  b = LSB - MSB;
...
CardInformationInfo UHF_RFID_2::Access_Password_is_incorrect()
{
...
CardInformationInfo UHF_RFID_2::EPC_Gen2_error_code()
{
  CardInformationInfo Cardinformation;
...
CardInformationInfo UHF_RFID_2::Operation_is_successful()
{
  CardInformationInfo Cardinformation;
...
CardInformationInfo UHF_RFID_2::UI_PC_EPC()
{
  CardInformationInfo Cardinformation;
